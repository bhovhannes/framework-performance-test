...
/* 0 */
/*!**************************************!*\
  !*** ./src/angular12-hacks/index.js ***!
  \**************************************/
/***/ function(module, exports, __webpack_require__) {

	'use strict';
	
	__webpack_require__(/*! angular12 */ 1);
	
	var _module = angular.module('PerfTest', ['ng']);
	__webpack_require__(/*! ./perf-test-app.directive */ 11)(_module);
...
/* 1 */
/*!***********************************************!*\
  !*** ./bower_components/angular12/angular.js ***!
  \***********************************************/
	        ...
	        function $watchCollectionWatch() {
	          ...
	          if (!isObject(newValue)) { // if primitive
	            if (oldValue !== newValue) {
	              oldValue = newValue;
	              changeDetected++;
	                console.log('primitive newValue=', newValue, ' oldValue=', oldValue);
	            }
	            ...
	            if (oldValue !== internalArray) {
	             ...
	             // console.log('isArrayLike newValue.length=', newValue.length, ' oldLength=', oldLength);
...
/* 7 */
/*!***************************************!*\
  !*** ./src/common/updateStatsHood.js ***!
  \***************************************/
/***/ function(module, exports, __webpack_require__) {

	'use strict';
	
	var mustache = __webpack_require__(/*! mustache */ 8);
	var hoodTemplate = __webpack_require__(/*! ./hood.mustache.html */ 9);
...
/* 9 */
/*!***************************************!*\
  !*** ./src/common/hood.mustache.html ***!
  \***************************************/
/***/ function(module, exports) {

	module.exports = "<div class=\"text-secondary\">\n\t<div class=\"divider-after\">Initial render duration: <span class=\"text-primary\">{{firstRenderDuration}}</span></div>\n\t<br/>\n\t<div class=\"divider-after\">Rendered cell count: <span class=\"text-primary\">{{totalCellCount}}</span></div>\n\n\t<div class=\"title divider-after\">Full render (<span class=\"text-primary\">{{renderCount}}</span> times)</div>\n\t<div>Last render duration: <span class=\"text-primary\">{{lastRenderDuration}}</span></div>\n\t<div>Average render duration: <span class=\"text-primary\">{{averageRenderDuration}}</span></div>\n\n\t<div class=\"title divider-after\">Partial render (<span class=\"text-primary\">{{partialRenderCount}}</span> times)</div>\n\t<div>Last render duration: <span class=\"text-primary\">{{lastPartialRenderDuration}}</span></div>\n\t<div>Average render duration: <span class=\"text-primary\">{{averagePartialRenderDuration}}</span></div>\n</div>"
...
/* 11 */
/*!********************************************************!*\
  !*** ./src/angular12-hacks/perf-test-app.directive.js ***!
  \********************************************************/
/***/ function(module, exports, __webpack_require__) {

	'use strict';
	
	var template = __webpack_require__(/*! ./perf-test-app.html */ 12);
	
	var dataSize = __webpack_require__(/*! ../common/dataSize */ 4);
	var generateData = __webpack_require__(/*! ../common/generateData */ 5);
	var getRandomColor = __webpack_require__(/*! ../common/getRandomColor */ 6);
	var updateStatsHood = __webpack_require__(/*! ../common/updateStatsHood */ 7);
	var Timer = __webpack_require__(/*! ../common/timer */ 10);
	...
	var directive = [function () {
		return {
			...
			link: function link(scope) {
				...
				var getAverageRenderDuration = function getAverageRenderDuration() {
				...
				var getAveragePartialRenderDuration = function getAveragePartialRenderDuration() {
	...
	var decorateRootScope = function decorateRootScope($delegate) {
...
/* 12 */
/*!************************************************!*\
  !*** ./src/angular12-hacks/perf-test-app.html ***!
  \************************************************/
/***/ function(module, exports) {

	module.exports = "<button ng-click=\"handleRenderClick()\">Render</button>\n<button ng-click=\"handlePartialRenderClick()\" ng-if=\"__fastWatched__getCells().length>0\">Render {{partialCellsCount}} random cells</button>\n<div class=\"table\">\n\t<div ng-repeat=\"row in __fastWatched__getCells() track by $index\" class=\"row\">\n\t\t<div ng-repeat=\"cell in row track by $index\" class=\"cell\" ng-style=\"getCellStyle(cell)\">{{cell.index}}</div>\n\t</div>\n</div>"

/***/ }
/******/ ])
});
;
//# sourceMappingURL=angular12-hacks.js.map