...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(/*! react13 */ 28),
	    PerfTestApp = __webpack_require__(/*! ./perf-test-app */ 29);
	
	React.render(React.createElement(PerfTestApp, null), document.getElementById('content'));
...
/* 28 */
/*!*******************************************!*\
  !*** ./bower_components/react13/react.js ***!
  \*******************************************/
/***/ function(module, exports) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var hoodTemplate = __webpack_require__(/*! ./hood.mustache.html */ 30);
	var PerfTestCell = __webpack_require__(/*! ./perf-test-cell */ 31);
	
	var PerfTestApp = React.createClass({
		displayName: 'PerfTestApp',
		...
		getAverageRenderDuration: function getAverageRenderDuration() {
		...
		getAveragePartialRenderDuration: function getAveragePartialRenderDuration() {
		...
		handlePartialRenderClick: function handlePartialRenderClick() {
			...
			return React.createElement(
				...
				(function () {
					if (this.state.cells.length > 0) {
						return React.createElement(
							'button',
							{ onClick: this.handlePartialRenderClick },
							'Render ',
							dataSize.partialCellsCount,
							' random cells'
						);
					}
				}).call(this),
					...
					this.state.cells.map(function (row, rowIndex) {
						return React.createElement(
							...
							row.map(function (cell, colIndex) {
								return React.createElement(PerfTestCell, { cell: cell });
							})
						);
					}, this)
				)
...
/* 30 */
/*!****************************************!*\
  !*** ./src/react13/hood.mustache.html ***!
  \****************************************/
/***/ function(module, exports) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PerfTestCell = React.createClass({
		...
		render: function render() {
			...
			return React.createElement(
				'div',
				{ className: 'cell', key: this.props.cell.index, style: cellStyle },
				this.props.cell.index
			);
		}
	});
...
;
//# sourceMappingURL=react13.js.map